...
- add author-year references using the pattern `cite:[riscvtr(12)]` or - `cite:[riscvtr(12)]`.
- add age numbers (locators) using the pattern `cite:[Kim-micro2005(45)]` or `citenp:[Kim-micro2005(45)]`.
- add pretext using the pattern `cite:See[Kim-micro2005(45)]`.
...
When using the automated option, _do not_ manually add entries to the bibliography.adoc file.
