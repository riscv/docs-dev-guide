...
| Change spec-sample::index.adoc to be <your short name>::index.adoc
...
When a PDF file is build, the full title is derived from the short name, the version, and the build date (`<short>-vX.Y-YYYYMMDD.pdf`) automatically.
...
Note that your Citations and `bibliography::[]` render as raw text** locally. The ASAM 
...
When your spec development is complete and ratified, the RISC-V team creates a ratified version and publishes the document in the docs.riscv website.
