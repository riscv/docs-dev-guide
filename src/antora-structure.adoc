...
The `antora.yml` file at the repository root is the Antora https://docs.antora.org/antora/latest/component-version-descriptor/[component descriptor]. It identifies the repository as an Antora content component and provides metadata used when the site is assembled.
