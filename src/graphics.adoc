...
[source,adoc]
....
include::images/wavedrom/instruction_format.adoc
[[instruction_formats]]
.Test for wavedrom
...
include::partial$wavedrom/instruction_format.adoc[]
[[instruction_formats]]
.Test for wavedrom
image::image_placeholder.png[]
...
.Sample litmus test
partials::graphviz/litmus_sample.txt[align="center"]
...
At the time of this writing, we have noticed the following unexpected results during diagram builds that use the asciidoctor-pdf toolchain, as follows:
