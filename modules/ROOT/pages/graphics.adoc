...
. Wavedrom code for all diagrams in this illustration are stored in `../partials/wavedrom` subdirectory within the partials directory.
...
[source,adoc]
----
include::../partials/wavedrom/filename.adoc
----
====
...
* store scripts for Graphviz diagrams in the `graphviz` subdirectory within the images directory (modules/ROOT/images/graphviz/), as <filename>.txt
