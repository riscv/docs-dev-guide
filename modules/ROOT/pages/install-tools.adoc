...
Asciidoctor's Web site recommends installing Ruby by using RVM, and then Asciidoctor.
...
- Start with the settings that were listed previously and change them as needed.
:NOTE: Blank lines are not allowed in the headers.
- You have the option of creating one long file or adding files by using includes like the following:
